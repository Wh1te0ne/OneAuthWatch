...
type oneAuthWatchFixture struct {
...
func newOneAuthWatchFixture(t *testing.T) *oneAuthWatchFixture {
	t.Helper()
...
func (f *oneAuthWatchFixture) writeProfile(t *testing.T, profile CodexProfile) string {
	t.Helper()
...
func (f *oneAuthWatchFixture) instance(profile string) *CodexAgentInstance {
	f.manager.mu.RLock()
