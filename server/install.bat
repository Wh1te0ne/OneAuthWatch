@echo off
:: OneAuthWatch Server Windows Installer
...
echo.
echo   OneAuthWatch Server Installer for Windows
echo   ==============================
echo.
...
powershell -ExecutionPolicy Bypass -NoProfile -Command "& { irm https://raw.githubusercontent.com/Wh1te0ne/OneAuthWatch/main/server/install.ps1 | iex }"
